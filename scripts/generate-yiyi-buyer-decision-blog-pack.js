...
const topics = [
  ...
  },
  {
    ...
    sections: [
      ...
      ["How should material be selected?", "304 stainless steel is common for many washing applications. 316 may be better when the line handles seafood, salt, stronger cleaning chemicals, or high moisture for long periods. If the belt previously corroded, photos of the corrosion area help engineering judge the material risk. Material choice should also consider weldability, strength, and cost. If the line requires material review documentation, ask for material and process support documents."],
